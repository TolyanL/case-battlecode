...
def get_recent_activity(user_id: int, assignments: list[Assignment]) -> list:
    DIFFICULTY_COLORS = {
    ...
    for assignment in assignments:
        ...
        assignment.max_reviews = REVIEW_COUNT
...
def get_pref_langs_data(assignments: list[Assignment], top_n: int = 10):
    ...
    top_langs = [{**lang, "percentage": round(lang["percentage"])} for lang in lang_list[:top_n]]
